...
function resizeWindow(){
	...
	let note = d3.select('#app').append('div')
		.style('position','fixed')
		.style('top','100px')
		.style('text-align','center')
		.style('width','100%')
		.style('font-family','Times New Roman" ,"Microsoft YaHei')
		.style('opacity',0.2)
		.style('font-size','30px')
	
	note.append('div')
		.text('请设置屏幕分辨率为 1920*1080')
	note.append('div')
		.text('缺少查询后台，Condition Specification View 无法演示')
}
resizeWindow()
// 初始化
CaseMockFlag = true
